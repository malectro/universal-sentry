...
unwrapExports(dist);
var dist_1 = dist.Scope;
var dist_2 = dist.Hub;
var dist_3 = dist.getDefaultHub;
...
var dist_5 = dist$1.configureScope;
var dist_6 = dist$1._callOnClient;
...
function initAndBind(clientClass, options, defaultIntegrations) {
    ...
    if (dist.getDefaultHub().getClient()) {
        return;
    }
    ...
    dist.getDefaultHub().bindClient(client);
...
var dist_1 = dist$$1.Severity;
var dist_2 = dist$$1.Status;
...
var BrowserBackend = /** @class */ (function () {
    ...
    BrowserBackend.prototype.install = function () {
        ...
        Raven$2.setBreadcrumbCallback(function (breadcrumb) {
            dist$1.addBreadcrumb(breadcrumb);
            return false;
        });
        Raven$2._sendProcessedPayload = dist$1.captureEvent;
        return true;
    };
    /**
     * @inheritDoc
...
var OnUnhandledRejection = /** @class */ (function () {
    ...
    OnUnhandledRejection.prototype.handler = function (event) {
        dist$1.captureException(event.reason);
    };
    /**
     * @inheritDoc
     */
...
var SDKInformation = /** @class */ (function () {
    ...
    SDKInformation.prototype.install = function () {
        var _this = this;
        dist.getDefaultHub().addEventProcessor(function (event) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
exports.getDefaultHub = dist.getDefaultHub;
exports.Hub = dist.Hub;
exports.Scope = dist.Scope;
...
var index$4 = unwrapExports(dist_3$3);
...
exports.addBreadcrumb = dist_4$3;
exports.captureMessage = dist_5$2;
exports.captureException = dist_6$2;
exports.captureEvent = dist_7$1;
exports.configureScope = dist_8$1;
exports.getHubFromCarrier = dist_9$1;
exports.getDefaultHub = dist_10$1;
exports.Hub = dist_11;
exports.Scope = dist_12;
exports.Integrations = dist_13;
exports.Transports = dist_14;
exports.Severity = dist_15;
exports.Status = dist_16;
exports.BrowserBackend = dist_17;
exports.BrowserClient = dist_18;
exports.defaultIntegrations = dist_19;
exports.init = dist_20;
exports.SDK_NAME = dist_21;
exports.SDK_VERSION = dist_22;
